 ...
 <nav class="app-header navbar navbar-expand bg-body">
     ...
     <div class="container-fluid">
         ...
         <ul class="navbar-nav">
             ...
             <li class="nav-item">
                 <a href="https://github.com/1acto/88823665-camp-66/tree/Laravel-BS5" class="nav-link align-middle">
                    <i class="bi bi-github me-2"></i>
                    <span class="text-dark">-<span class="badge bg-primary ms-2 align-middle"><i class="bi bi-diagram-2">-</i></pan></span>
                     <!--end::Brand Text-->
                 </a>
             </li>
